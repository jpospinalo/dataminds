...
class BaseClient(BaseModel):
    ...
    tipo_documento: str = Field(
        min_length=5,
        max_length=15,
        regex=r"^\d{5,15}$",  # Asegura que sean solo dígitos entre 5 y 15 caracteres
    ...
    primer_nombre: str = Field(
        min_length=1,
        max_length=50,
        regex=r"^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]+$",  # Solo letras y espacios
        title="Primer Nombre",
    ...
    segundo_nombre: str | None = Field(
        min_length=1,
        max_length=50,
        regex=r"^[a-zA-ZáéíóúÁÉÍÓÚñÑ\s]*$",  # Letras, espacios, o vacío
